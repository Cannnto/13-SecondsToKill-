...
//--------------Front-------------------
    ...
    {   i(e);
        ...
        r(x + w*2/8, y - h*4/8, w*4/8, h*0.75/8, '#D9D9D9');
...
//----sword draw----
    ...
    {   i(e);
        ...
        let bl1 = {x:(x1+w/24),y:(y-h/2 - c)+20*sin(a),w:w/6,h:h*9/16};
